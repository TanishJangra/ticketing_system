...
const ChatBot = ({ chatConfig }) => {
  ...
  const [headerColor, setHeaderColor] = useState(
    chatConfig?.headerColor || "#33475B"
  );
  const [messageBackgroundColor, setMessageBackgroundColor] = useState(
    chatConfig?.messageBackgroundColor || "#d5d6da"
  );
  const [messageFontColor, setMessageFontColor] = useState(
    chatConfig?.messageFontColor || "#000000"
  );
  const [introMsg1, setIntroMsg1] = useState(
    chatConfig?.customizedMessages[0] || "How can I help you?"
  );
  const [introMsg2, setIntroMsg2] = useState(
    chatConfig?.customizedMessages[1] || "Ask me anything!"
  );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(
        "https://ticketing-system-usx8.onrender.com/api/chatCustomization",
        payload,
        {
          headers: {
      ...
      <div className="middleContainer">
        <div className="chatContainer">
          <div className="header" style={{ backgroundColor: headerColor }}>
            ...
            <p
              style={{
                color: chatConfig?.headerFontColor
                  ? chatConfig?.headerFontColor
                  : "#FFFFFF",
              }}
            >
              Hubly
            ...
            {["white", "black", "#33475B"].map((color) => (
              <div
                ...
                style={{
                  ...
                  border: headerColor === color ? "2px solid #000" : "none",
                }}
